...
<html lang="en-US" class="">
    <head>
        ...
        <script type="text/javascript" async="" src="./Guestbook - www.simplesite.com_us-123wedding_files/analytics.js"></script>
        <script async="" src="./Guestbook - www.simplesite.com_us-123wedding_files/gtm.js"></script>
        <script type="text/javascript" src="./Guestbook - www.simplesite.com_us-123wedding_files/FrontendAppLocalePage.aspx"></script>
                ...
                <div id="left" class="span9"> <!-- ADD "span12" if no sidebar, or "span9" with sidebar -->
                    <div class="wrapper guest-book">
                        ...
                        <div class="content">
                            ...
                            <div class="section">
                                <div class="content">
                                    <c:forEach items="${listGuest}" var="c">
                                        <div class="item">
                                            <div class="controls">
                                                <a rel="nofollow" class="email" href="mailto:yy@123mail.com">Email</a>
                                                <span class="date-text">${c.getDate()}</span>
                                            </div>
                                            <div class="heading">
                                                <h4>${c.getName()}</h4>
                                            </div>
