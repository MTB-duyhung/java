...
<html lang="en-US" class="">
    <head>
        ...
        <title>Wedding Blog - www.simplesite.com/us-123wedding</title>
                                        ...
                                        <div class="section">
                                            <div class="content">
                                                <div class="item">
                                                    ...
                                                    <div class="heading">
                                                        <h4><a rel="nofollow" href="blog?id=${c.getId()}">${c.getTitle()}</a></h4>
                                                    </div>
                                                    ...
                                                    <div class="content">
                                                        ...
                                                        <p><span style="font-size: 16px;">${c.getContent()}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
