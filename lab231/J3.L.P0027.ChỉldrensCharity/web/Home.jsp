...
<html lang="en-US" class="">
    <head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <meta property="og:updated_time" content="2017-01-04T04:31:16.6309715+00:00">
        ...
        <link rel="stylesheet" type="text/css" href="./Home_files/9767413.design.v27169.css">
    ...
    <body data-pid="422328012" data-iid="">
                                    ...
                                    <div class="section article">
                                        ...
                                        <div class="content">
                                            <div class="img-simple  ">
                                                <div class="image">
                                                    <a rel="nofollow" data-ss="imagemodal" data-href="${post1.getImg()}"><img src="${post1.getImg()}"></a>
                                                </div>
                                            </div>
                                            <p>${post1.getContent()}</p>    </div>
                                    </div>
                                    <div class="section article">
                                        <style>    .wordwrapfix {
                                                word-wrap:break-word;
                                        ...
                                        <div class="heading wordwrapfix">
                                            <h3>${post2.getTitle()}</h3>
                                        </div>

                                        <div class="content">
                                            <div class="img-simple span3 pull-left">
                                                <div class="image">
                                                    <a rel="nofollow" data-ss="imagemodal" data-href="${post2.getImg()}"><img src="${post2.getImg()}"></a>
                                                </div>
                                            </div>
                                            <p>${post2.getContent()}</p> 
                                            <p><a rel="nofollow" href="${post2.getLink()}">How to Help</a></p>    </div>
                                    </div>
                                    <div class="section news">
                                        ...
                                        <div class="content">
                                            <dl class="dl-horizontal">
                                                <c:forEach items="${listpost}" var="c">
                                                <dt><span class="date-text">${c.getDate()}</span></dt>
                                                <dd>
                                                    <h4>${c.getTitle()}</h4>
                            ...
                            <div class="sidebar">
                                <div class="wrapper share-box">
                                    ...
                                    <div class="content">
                                        ...
                                        <input id="social_hash" type="hidden" value="b=66A7E6F62A6C96579D37E2D680144CABFE951817">
                                    </div>
                                </div>
        ...
        <div id="sm2-container" class="movieContainer high_performance  high_performance" style="z-index: 10000; position: fixed; width: 8px; height: 8px; bottom: 0px; left: 0px; overflow: hidden;"><embed name="sm2movie" id="sm2movie" src="/Images/sm297/soundmanager2_flash9.swf" quality="high" allowscriptaccess="always" bgcolor="#ffffff" pluginspage="www.macromedia.com/go/getflashplayer" title="JS/Flash audio component (SoundManager 2)" type="application/x-shockwave-flash" wmode="transparent" haspriority="true"></div><div style="display: none; visibility: hidden;"><script type="text/javascript">var google_conversion_id = 1066686464, google_custom_params = window.google_tag_params, google_remarketing_only = !0;</script>
