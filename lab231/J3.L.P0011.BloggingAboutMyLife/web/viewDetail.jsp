<%-- 
    Document   : viewDetail
    Created on : Sep 16, 2020, 1:36:09 PM
    Author     : PC
--%>
...
<html lang="en-US">
    <head>
        ...
        <meta property="og:description" content="&quot;?You&#39;ve gotta dance like there&#39;s nobody watching,
              ...
              And live like it&#39;s heaven on earth.? &quot; - William W. Purkey" />        <meta property="og:updated_time" content="2019-10-21T02:45:36.9635324Z" />
                                    ...
                                    <div class="blog-post-body section"> 
                                        ...
                                        <div class="content">
                                            <div class="img-simple span6 pull-left">
                                                <div class="image">
                                                    <a rel="nofollow" data-ss="imagemodal" datahref="http://cdn.simplesite.com/i/2b/ac/283445309157387307/i283445314544979646._szw1280h1280_.jpg"><img
                                                            src="<%=b.getImage()%>"></a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="content">
                                            <div class="img-simple  ">
                                                <div class="image">
                                                    <a rel="nofollow" data-ss="imagemodal" datahref="http://cdn.simplesite.com/i/2b/ac/283445309157387307/i283445314544979644._szw1280h1280_.jpg"><img
                                                            src="<%=b.getImage()%>"></a>
                                                </div>
                                            </div>
                        ...
                        <div id="right" class="span3  " >
                            <div class="sidebar">
                                ...
                                <div class="wrapper viral-box">
                                    <style>    .wordwrapfix {                                          word-wrap:break-word;
                                        }
                                    </style>
                                    <div class="heading wordwrapfix">
    ...
    dataLayer = [{"SiteVer": "US", "MainOrUser": "UserPage", "PreOrFre": "Free", "Language": "en", "Culture": "en-US",
        ...
        <script type="text/javascript">
            ...
            if (e.session && e.session.options)
                    ...
                    i[option] = e.session.options[option]; var t = {api_version: r, locale: u.locale(), current_session: u.session(), original_session: u.session(i.session_cookie,
            ...
            if (n.indexOf(e[t].subString) != - 1)
                    ...
                    return r.viewport = {width: e.innerWidth || t.documentElement.clientWidth || t.body.clientWidth, height:
                            e.innerHeight || t.documentElement.clientHeight || t.body.clientHeight}, r.is_tablet = !!n.userAgent.match(/(iPad|SCHI800|xoom|kindle)/i),
                            r.is_phone = !r.isTablet && !!n.userAgent.match(/(iPhone|iPod|blackberry|android 0.5|htc|lg|midp|mmp|mobile|nokia|opera mini|palm|pocket|psp|sgh|smartphone|
                                    symbian | treo mini | Playstation Portable | SonyEricsson | Samsung | MobileExplorer | PalmSource | Benq | Windows Phone | Windows Mobile | IEMobile | Windows CE | Nintendo Wii) / i),
                            r.is_mobile = r.is_tablet || r.is_phone, r
                    }, plugins: function () {
                    var e = function (e) {
                    if (n.plugins) {
                    ...
                    if (e.statusCode === "OK")
                            e.source = "ipinfodb", a.set_cookie(i.location_cookie, a.package_obj(e), i.location_cookie * 60 * 60 * 1e3),
                            n(e);
                    else {
                    if (i.gapi_location)
