 ...
 * @author Admin
 */
public class SP0007 extends javax.swing.JFrame {

    public SP0007() {
        initComponents();
        setSize(400, 200);
        GraphicsEnvironment g = GraphicsEnvironment.getLocalGraphicsEnvironment();
        String[] list = g.getAvailableFontFamilyNames();
        for (String fonts : list) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SP0007.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
