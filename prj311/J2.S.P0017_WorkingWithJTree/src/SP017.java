...
public class SP017 extends JPanel implements TreeSelectionListener {
    ...
    public SP017() {
        ...
        ImageIcon tutorialIcon = createImageIcon("star.jpg");
    ...
    private class BookInfo {
        ...
        public BookInfo(String book, String filename) {
            bookName = book;
            bookURL = SP017.class.getResource(filename);
            if (bookURL == null) {
    ...
    private void initHelp() {
        ...
        helpURL = SP017.class.getResource(s);
        if (helpURL == null) {
    ...
    protected static ImageIcon createImageIcon(String path) {
        java.net.URL imgURL = SP017.class.getResource(path);
        if (imgURL != null) {
    ...
    private static void createAndShowGUI() {
        ...
        SP017 newContentPane = new SP017();
